    ...
    <section
        ...
        <div class="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-2xl items-center relative z-10">
            <div class="space-y-lg">
                <span class="korean-label opacity-0 animate-slide-left">SELAMAT DATANG DI ALL CLEAN LAUNDRY</span>

                <h1 class="font-h1 text-headline-xl-mobile md:text-headline-xl text-text-primary leading-[1.1] opacity-0 animate-slide-left animate-delay-100">
                    Cek Status Cucian Anda <br />
                    <span class="text-primary-container">Secara Real-Time</span>
                </h1>

                <p class="text-text-secondary text-lg max-w-lg opacity-0 animate-slide-left animate-delay-200">
                ...
                <div class="glass-card p-lg rounded-xl shadow-xl shadow-primary/5 max-w-md shimmer opacity-0 animate-slide-left animate-delay-300">
                ...
                <div class="flex items-center gap-lg pt-md opacity-0 animate-slide-left animate-delay-400">
