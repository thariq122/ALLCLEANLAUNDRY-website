...
<nav class="fixed top-0 w-full z-50 bg-surface/80 dark:bg-surface-dim/80 backdrop-blur-md border-b border-border shadow-sm">
    <div class="flex justify-between items-center px-margin-mobile md:px-margin-desktop h-20 max-w-7xl mx-auto">
        <div class="flex items-center gap-md">
            <img class="h-12 w-12 rounded-xl object-contain shadow-sm" src="{{ asset('images/logo.png') }}" alt="All Clean Laundry Logo" />
        ...
        <div class="hidden md:flex items-center gap-lg">
            <a class="nav-link active text-primary font-bold font-body-md" href="#home" data-nav-link="home">Beranda</a>
            <a class="nav-link text-on-surface-variant hover:text-primary transition-colors font-body-md" href="#about" data-nav-link="about">Tentang Kami</a>
            <a class="nav-link text-on-surface-variant hover:text-primary transition-colors font-body-md" href="#services" data-nav-link="services">Layanan &amp; Harga</a>
            <a class="nav-link text-on-surface-variant hover:text-primary transition-colors font-body-md" href="#tnc" data-nav-link="tnc">Syarat &amp; Ketentuan</a>
            <a class="nav-link text-on-surface-variant hover:text-primary transition-colors font-body-md" href="#location" data-nav-link="location">Lokasi</a>
            <a class="ml-4 px-lg py-md bg-primary-container text-white rounded-full font-bold hover:bg-primary-hover transition-all scale-95 active:scale-90 btn-hover-effect" href="{{ url('/login') }}">
                Area Kasir
            </a>
        </div>
    ...
    <section class="relative overflow-hidden min-h-[921px] flex items-center px-margin-mobile md:px-margin-desktop bg-pattern" id="home">
        <div class="absolute top-20 right-10 w-64 h-64 bg-primary-fixed/20 rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute bottom-10 left-10 w-96 h-96 bg-secondary-fixed/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        ...
        <div class="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-2xl items-center relative z-10">
            <div class="space-y-lg reveal">
                ...
                <p class="text-text-secondary text-lg max-w-lg">
                    Gak perlu repot bolak-balik ke outlet. Masukkan nomor nota Anda dan pantau proses laundry mulai dari pencucian hingga siap diantar.
                </p>
                ...
                <div class="flex items-center gap-lg pt-md">
                    <div class="flex -space-x-3">
                        <div class="w-10 h-10 rounded-full border-2 border-white bg-primary-fixed-dim"></div>
                        <div class="w-10 h-10 rounded-full border-2 border-white bg-secondary-fixed-dim"></div>
                        <div class="w-10 h-10 rounded-full border-2 border-white bg-tertiary-fixed-dim"></div>
                    </div>
            ...
            <div class="relative hidden lg:block h-[600px] reveal">
                <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full flex items-center justify-center">
                    ...
                    <div class="absolute bottom-20 left-0 glass-card p-md rounded-xl shadow-lg flex items-center gap-sm animate-float [animation-delay:2s]">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-2xl items-center">
                ...
                <div class="space-y-lg reveal">
                    ...
                    <p class="text-text-secondary text-lg">
                        Kami mengutamakan kualitas dengan menggunakan deterjen ramah lingkungan yang aman untuk kulit sensitif dan menjaga serat kain tetap awet. Proses pencucian dipisahkan antar pelanggan (1 mesin 1 pelanggan) untuk menjamin higienitas maksimal.
                    </p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-lg pt-md">
                        <div class="flex items-center gap-md p-md rounded-xl bg-background border border-border transition-transform hover:scale-105">
    ...
    <section class="py-3xl px-margin-mobile md:px-margin-desktop bg-background" id="services">
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-lg">
            @forelse(collect($daftarLayanan ?? []) as $layanan)
                ...
                @endphp
                <div class="glass-card p-xl rounded-xl border border-border flex flex-col items-center text-center group hover:shadow-2xl transition-all hover:-translate-y-2 reveal shimmer">
                    <div class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center text-primary mb-lg group-hover:bg-primary group-hover:text-white transition-all">
                        <span class="material-symbols-outlined text-3xl">{{ $icon }}</span>
                    </div>
                    <h3 class="font-h2 text-xl mb-sm">{{ $layanan->nama_layanan }}</h3>
                    <p class="text-text-secondary text-sm mb-lg">{{ $layanan->deskripsi ?? 'Layanan laundry profesional dengan proses cepat dan rapi.' }}</p>
                    <div class="mt-auto">
                        <p class="text-primary font-bold text-2xl">Rp {{ number_format((float) $layanan->harga, 0, ',', '.') }}<span class="text-sm font-normal text-text-secondary">/{{ $layanan->jenis_satuan ?? 'Kg' }}</span></p>
            ...
            @empty
                <div class="glass-card p-xl rounded-xl border border-border flex flex-col items-center text-center group hover:shadow-2xl transition-all hover:-translate-y-2 reveal shimmer">
                    ...
                    <div class="mt-auto">
                        <p class="text-primary font-bold text-2xl">Rp 8.000<span class="text-sm font-normal text-text-secondary">/Kg</span></p>
                        <span class="text-xs text-secondary font-bold">⭐ Terpopuler</span>
                    </div>
                </div>
            @endforelse
    ...
    <section class="py-3xl px-margin-mobile md:px-margin-desktop bg-primary relative overflow-hidden" id="booking">
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/bg-laundry.jpg') }}');"></div>
        <div class="absolute inset-0 bg-primary/80"></div>
        <div class="absolute inset-0 opacity-10 bg-pattern"></div>
        <div class="max-w-5xl mx-auto relative z-10 reveal">
            <div class="text-center mb-2xl">
                <span class="bg-white/20 text-white px-md py-xs rounded-full text-xs font-bold uppercase tracking-widest">BOOKING PICKUP</span>
            ...
            @if(session('success'))
                <div class="mb-lg rounded-xl border border-white/20 bg-white/15 px-lg py-md text-white shadow-lg backdrop-blur-sm">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <div class="bg-white p-2xl rounded-xl shadow-2xl">
                <form class="grid grid-cols-1 md:grid-cols-2 gap-lg" action="{{ url('/pickup') }}" method="POST">
                    ...
                    <div class="space-y-sm">
                        ...
                        <input class="w-full rounded-xl border-border focus:ring-primary focus:border-primary" name="nama_pelanggan" placeholder="Masukkan nama Anda" type="text" value="{{ old('nama_pelanggan') }}" />
                    ...
                    <div class="space-y-sm">
                        ...
                        <input class="w-full rounded-xl border-border focus:ring-primary focus:border-primary" name="nomor_hp" placeholder="0812xxxx" type="tel" value="{{ old('nomor_hp') }}" />
                        @error('nomor_hp')
                            <p class="text-sm font-medium text-error">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="md:col-span-2 space-y-sm">
                        ...
                        <textarea class="w-full rounded-xl border-border focus:ring-primary focus:border-primary" name="alamat_pickup" placeholder="Tulis alamat lengkap penjemputan" rows="2">{{ old('alamat_pickup') }}</textarea>
                        @error('alamat_pickup')
                            <p class="text-sm font-medium text-error">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="space-y-sm">
                        ...
                        <select class="w-full rounded-xl border-border focus:ring-primary focus:border-primary" name="layanan_id">
                            <option value="">-- Pilih Layanan --</option>
                            @forelse(collect($daftarLayanan ?? []) as $layanan)
                                <option value="{{ $layanan->id }}" @selected(old('layanan_id') == $layanan->id)>
                                    {{ $layanan->nama_layanan }} - Rp {{ number_format((float) $layanan->harga, 0, ',', '.') }}/{{ $layanan->jenis_satuan ?? 'Kg' }}
                                </option>
                            @empty
                    ...
                    <div class="grid grid-cols-2 gap-md">
                        <div class="space-y-sm">
                            ...
                            <input class="w-full rounded-xl border-border focus:ring-primary focus:border-primary" name="tanggal_pickup" type="date" value="{{ old('tanggal_pickup') }}" />
                        ...
                        <div class="space-y-sm">
                            ...
                            <input class="w-full rounded-xl border-border focus:ring-primary focus:border-primary" name="jam_pickup" type="time" value="{{ old('jam_pickup') }}" />
                            @error('jam_pickup')
                                <p class="text-sm font-medium text-error">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-sm">
                        ...
                        <input class="w-full rounded-xl border-border focus:ring-primary focus:border-primary" name="jumlah" placeholder="Contoh: 3.5" step="0.1" type="number" value="{{ old('jumlah') }}" />
                        @error('jumlah')
                            <p class="text-sm font-medium text-error">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="md:col-span-2 space-y-sm">
                        ...
                        <input class="w-full rounded-xl border-border focus:ring-primary focus:border-primary" name="catatan_tambahan" placeholder="Contoh: Titip di satpam jika saya tidak ada" type="text" value="{{ old('catatan_tambahan') }}" />
                        @error('catatan_tambahan')
                            <p class="text-sm font-medium text-error">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="md:col-span-2 pt-md">
                        <button class="w-full bg-secondary text-white py-md rounded-full font-bold text-lg hover:brightness-110 transition-all flex items-center justify-center gap-md btn-hover-effect" type="submit">
        ...
        <div class="max-w-4xl mx-auto reveal">
            ...
            <div class="bg-background rounded-xl p-md">
                <div class="flex gap-md mb-lg">
                    <button class="flex-1 py-md rounded-xl font-bold transition-all bg-primary text-white shadow-lg btn-hover-effect" id="tab-btn-order" onclick="toggleTab('order')">Tab Order</button>
                    <button class="flex-1 py-md rounded-xl font-bold transition-all text-text-primary hover:bg-white" id="tab-btn-kiloan" onclick="toggleTab('kiloan')">Tab Kiloan</button>
                </div>
                <div class="space-y-md p-lg" id="tab-content-order">
                    <div class="flex gap-md">
                        <span class="material-symbols-outlined text-secondary" style="font-variation-settings: 'FILL' 1;">check_circle</span>
                        <p class="text-text-secondary">Pemesanan melalui WhatsApp atau website akan segera diproses tim kurir.</p>
                    </div>
                    <div class="flex gap-md">
                        <span class="material-symbols-outlined text-secondary" style="font-variation-settings: 'FILL' 1;">check_circle</span>
                        <p class="text-text-secondary">Pembayaran dapat dilakukan melalui transfer bank atau tunai saat pengembalian.</p>
                    </div>
                    <div class="flex gap-md">
                        <span class="material-symbols-outlined text-secondary" style="font-variation-settings: 'FILL' 1;">check_circle</span>
                        <p class="text-text-secondary">Waktu pengerjaan dihitung sejak pakaian diterima oleh petugas outlet kami.</p>
                    </div>
                </div>
                <div class="hidden space-y-md p-lg" id="tab-content-kiloan">
                    ...
                    <div class="flex gap-md">
                        <span class="material-symbols-outlined text-secondary" style="font-variation-settings: 'FILL' 1;">check_circle</span>
                        <p class="text-text-secondary">Pakaian luntur harus dipisahkan, kerusakan akibat luntur diluar tanggung jawab kami.</p>
                    </div>
                    <div class="flex gap-md">
                        <span class="material-symbols-outlined text-secondary" style="font-variation-settings: 'FILL' 1;">check_circle</span>
                        <p class="text-text-secondary">Barang berharga di saku harus dikeluarkan sendiri oleh pelanggan.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-lg">
                <div class="glass-card p-xl rounded-xl shadow-lg reveal shimmer transition-transform hover:scale-105">
                    ...
                    <p class="text-text-primary italic mb-lg">"Layanannya juara! Pernah coba kilat 4 jam beneran kelar dan wanginya awet banget."</p>
                    <div class="flex items-center gap-md">
                ...
                <div class="glass-card p-xl rounded-xl shadow-lg md:translate-y-4 reveal shimmer transition-transform hover:scale-105">
                    <div class="flex text-amber-400 mb-md">
                        <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
                        <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
                        <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">star</span>
                    ...
                    <p class="text-text-primary italic mb-lg">"Fitur cek status via website bantu banget, jadi ga perlu tanya-tanya terus lewat WA."</p>
                    <div class="flex items-center gap-md">
                ...
                <div class="glass-card p-xl rounded-xl shadow-lg reveal shimmer transition-transform hover:scale-105">
                    ...
                    <p class="text-text-primary italic mb-lg">"Kurir pickup ramah dan tepat waktu. Sangat membantu buat saya yang sibuk kerja."</p>
                    <div class="flex items-center gap-md">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-lg min-h-[500px]">
                <div class="lg:col-span-1 space-y-lg flex flex-col justify-center reveal">
                    ...
                    <a class="inline-flex items-center justify-center bg-primary-container text-white py-md px-lg rounded-full font-bold hover:brightness-110 transition-all btn-hover-effect" href="https://maps.app.goo.gl/Z6ovJ6Li4qrNbk6G7" target="_blank" rel="noopener noreferrer">
                        Buka di Google Maps
                    </a>
                </div>
...
<footer class="bg-surface-container-low dark:bg-inverse-surface border-t border-border w-full py-xl px-margin-mobile md:px-margin-desktop">
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-gutter">
        <div class="md:col-span-1">
            ...
            <p class="text-on-surface-variant text-sm mb-lg">Ahli laundry express profesional dengan standar higienitas tinggi untuk keluarga Anda.</p>
            <div class="flex gap-md">
                <a class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all btn-hover-effect" href="#">
        ...
        <div>
            ...
            <ul class="space-y-sm">
                <li><a class="text-on-surface-variant hover:text-primary transition-colors text-sm" href="#home">Beranda</a></li>
                <li><a class="text-on-surface-variant hover:text-primary transition-colors text-sm" href="#about">Tentang Kami</a></li>
                <li><a class="text-on-surface-variant hover:text-primary transition-colors text-sm" href="#services">Layanan &amp; Harga</a></li>
                <li><a class="text-on-surface-variant hover:text-primary transition-colors text-sm" href="#tnc">Syarat &amp; Ketentuan</a></li>
                <li><a class="text-on-surface-variant hover:text-primary transition-colors text-sm" href="#location">Lokasi</a></li>
            </ul>
        </div>
        <div>
        ...
        <div>
            ...
            <div class="mt-lg p-md bg-secondary/10 rounded-xl shimmer">
                <p class="text-xs font-bold text-secondary text-center uppercase tracking-widest">Laundry Profesional Bandung</p>
            </div>
        </div>
    </div>
...
<a class="fixed bottom-8 right-8 z-50 flex items-center gap-sm bg-secondary text-on-secondary rounded-full px-lg py-md shadow-xl shadow-secondary/20 hover:scale-110 hover:brightness-110 transition-all animate-subtle-pulse" href="https://wa.me/62081120081012" target="_blank">
